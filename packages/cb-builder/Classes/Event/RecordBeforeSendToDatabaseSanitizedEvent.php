...
/**
 * Event class for handling records before they are sent to the database, with sanitized data.
 */
final readonly class RecordBeforeSendToDatabaseSanitizedEvent
{
    /**
